...
#line 77 "parse_machine.c"
	{
	cs = uri_parse_start;
	}

#line 60 "parse_machine.rl"
  
#line 84 "parse_machine.c"
	{
	int _klen;
	unsigned int _trans;
	const char *_acts;
